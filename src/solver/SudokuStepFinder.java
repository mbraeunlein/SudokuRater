...
public class SudokuStepFinder {
    ...
    public List<SolutionStep> findAllNakedPairs(Sudoku2 newSudoku) {
    	initialize();
    	Sudoku2 oldSudoku = getSudoku();
        setSudoku(newSudoku);
        List<SolutionStep> steps = simpleSolver.findAllNakedXle();
        ArrayList<SolutionStep> remove = new ArrayList<SolutionStep>();
        for(int i = 0; i < steps.size(); i++) {
        	if(!steps.get(i).getStepName().equals("Naked Pair"))
        		remove.add(steps.get(i));
        }
        steps.removeAll(remove);
        setSudoku(oldSudoku);
        return steps;
    }
    
    public List<SolutionStep> findAllNakedTriples(Sudoku2 newSudoku) {
    	initialize();
    	Sudoku2 oldSudoku = getSudoku();
        setSudoku(newSudoku);
        List<SolutionStep> steps = simpleSolver.findAllNakedXle();
        ArrayList<SolutionStep> remove = new ArrayList<SolutionStep>();
        for(int i = 0; i < steps.size(); i++) {
        	if(!steps.get(i).getStepName().equals("Naked Triple"))
        		remove.add(steps.get(i));
        }
        steps.removeAll(remove);
        setSudoku(oldSudoku);
    ...
    public List<SolutionStep> findAllNakedQuadruples(Sudoku2 newSudoku) {
    	initialize();
    	Sudoku2 oldSudoku = getSudoku();
        setSudoku(newSudoku);
        List<SolutionStep> steps = simpleSolver.findAllNakedXle();
        ArrayList<SolutionStep> remove = new ArrayList<SolutionStep>();
        for(int i = 0; i < steps.size(); i++) {
        	if(!steps.get(i).getStepName().equals("Naked Quadruple"))
        		remove.add(steps.get(i));
        }
        steps.removeAll(remove);
        setSudoku(oldSudoku);
    ...
    public List<SolutionStep> findAllHiddenPairs(Sudoku2 newSudoku) {
    	initialize();
    	Sudoku2 oldSudoku = getSudoku();
        setSudoku(newSudoku);
        List<SolutionStep> steps = simpleSolver.findAllHiddenXle();
        ArrayList<SolutionStep> remove = new ArrayList<SolutionStep>();
        for(int i = 0; i < steps.size(); i++) {
        	if(!steps.get(i).getStepName().equals("Hidden Pair"))
        		remove.add(steps.get(i));
        }
        steps.removeAll(remove);
        setSudoku(oldSudoku);
    ...
    public List<SolutionStep> findAllHiddenTriples(Sudoku2 newSudoku) {
    	initialize();
    	Sudoku2 oldSudoku = getSudoku();
        setSudoku(newSudoku);
        List<SolutionStep> steps = simpleSolver.findAllHiddenXle();
        ArrayList<SolutionStep> remove = new ArrayList<SolutionStep>();
        for(int i = 0; i < steps.size(); i++) {
        	if(!steps.get(i).getStepName().equals("Hidden Triple"))
        		remove.add(steps.get(i));
        }
        steps.removeAll(remove);
        setSudoku(oldSudoku);
    ...
    public List<SolutionStep> findAllHiddenQuadruples(Sudoku2 newSudoku) {
    	initialize();
    	Sudoku2 oldSudoku = getSudoku();
        setSudoku(newSudoku);
        List<SolutionStep> steps = simpleSolver.findAllHiddenXle();
        ArrayList<SolutionStep> remove = new ArrayList<SolutionStep>();
        for(int i = 0; i < steps.size(); i++) {
        	if(!steps.get(i).getStepName().equals("Hidden Quadruple"))
        		remove.add(steps.get(i));
        }
        steps.removeAll(remove);
        setSudoku(oldSudoku);
