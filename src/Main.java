		...
		for (int i = 0; i < 5; i++) {
			...
			for (int j = 0; j < hodokuHardVectors.size(); j++) {
				if (!(j < i * (hodokuHardVectors.size() / 5) || j >= (i + 1)
					...
					switch (kn.classify(hodokuHardVectors.get(j), 20)) {
					case HodokuEasy:
						easy++;
						break;
					case HodokuMiddle:
			...
			Logger.log(LogLevel.Classification, "HodokuHard: " + rightCount
					+ " of " + totalCount + " sudokus correctly classified");
			/*
			Logger.log(LogLevel.Classification, easy + " classified as easy");
			Logger.log(LogLevel.Classification, middle
					+ " classified as middle");
			Logger.log(LogLevel.Classification, unfair
					+ " classified as unfair");
			Logger.log(LogLevel.Classification, extreme
