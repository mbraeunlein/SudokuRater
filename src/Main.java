...
public class Main {
	public static void main(String args[]) throws Exception {
		...
		classificatedVectors.put(Classification.soEinDingEinfach,
				soEinDingEinfach);
		classificatedVectors.put(Classification.soEinDingStandard,
				soEinDingStandard);
		classificatedVectors.put(Classification.soEinDingModerat,
				soEinDingModerat);
		classificatedVectors.put(Classification.soEinDingAnspruchsvoll,
				soEinDingAnspruchsvoll);
		classificatedVectors.put(Classification.soEinDingSehrAnspruchsvoll,
